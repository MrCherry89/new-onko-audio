$(document).ready(function () {
  ...
  $(".slider-for-banner").slick({
    asNavFor: ".slider-nav-banner, .slider-num-banner",
    slidesToShow: 1,
    slidesToScroll: 1,
    arrows: false,
    fade: true,
  ...
  $(".slider-nav-banner").slick({
    asNavFor: ".slider-for-banner, .slider-num-banner, .slider-vert-banner",
    focusOnSelect: true,
    centerMode: true,
    centerPadding: 0,
    dots: true,
  ...
  $(".slider-num-banner").slick({
    asNavFor: ".slider-for-banner, .slider-nav-banner, .slider-vert-banner",
    infinite: true,
    focusOnSelect: true,
    prevArrow: "",
    nextArrow: "",
  ...
  $(".slider-vert-banner").slick({
    asNavFor: ".slider-for-banner, .slider-nav-banner, .slider-num-banner",
    infinite: true,
    vertical: true,
